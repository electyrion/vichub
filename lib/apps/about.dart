...
class _AboutState extends State<About> {
  ...
  void initState() {
    ...
    super.initState();
    _iframeElementURL.src = 'https://drive.google.com/file/d/1YyHNeUx2eZpk0Q4I6VGrsbzrTSBhQ77f/preview';
              ...
              children: [
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      ...
                      TextSpan(
                          text: "App Developer from Indonesia 🇮🇩",
                          style: TextStyle(
                            fontSize: 19,
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                         "I am a CS undergraduate student from University of Indonesia. I now work as a freelance"
                            " App Developer. ",
                      style: TextStyle(
                        fontSize: 15,
                        color: Theme.of(context)
                ...
                Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        "Feel free to email me at vcy.maulana@gmail.com",
                        style: TextStyle(
                          fontSize: 15,
                          color: Theme.of(context)
                              .cardColor
                    ...
                    Expanded(
                      child: RichText(
                        text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                              text: "Faculty of Computer Science, University of Indonesia\n",
                              style: TextStyle(
                                color: Color(0xff118bff),
